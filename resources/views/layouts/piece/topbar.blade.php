<nav class="navbar navbar-default top-navbar" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand waves-effect waves-dark" href="/">
            ...
            <span class="label label-primary" style="font-size: 40%;position: absolute;left: 0;top: 0;">env [ {{ env('APP_ENV') }} ]</span>
        </a>
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li>
            <a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1">
                ...
                <b style="text-transform: capitalize">{{Auth::user()->name}}</b>
                <i class="material-icons right">arrow_drop_down</i>
            </a>
        </li>
    </ul>
