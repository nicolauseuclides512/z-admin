<nav class="navbar navbar-default top-navbar" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand waves-effect waves-dark" href="/">
            ...
            <strong>Zuragan Admin </strong>
            <span class="label label-primary" style="font-size: 40%;position: absolute;left: 0;top: 0;">env [ <?php echo e(env('APP_ENV')); ?> ]</span>
        </a>
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <!--                <i class="fa fa-tasks fa-fw"></i> <i class="material-icons right">arrow_drop_down</i>-->
        <!--            </a>-->
        <!--        </li>-->
        <!--        <li>-->
        ...
        <li>
            <a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1">
                ...
                <b style="text-transform: capitalize"><?php echo e(Auth::user()->name); ?></b>
                <i class="material-icons right">arrow_drop_down</i>
            </a>
        </li>
    </ul>
